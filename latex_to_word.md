...
packages. Transform some of the "LaTeX-isms" into MS Word equivalents: 
	- \% to %  
	- \$ to $ 
	- Triple dash for an em dash into a standard dash
...
sections, citations, tables etc. using Google Doc bookmarks and
headings.
1. Try to approximately match the formatting (e.g., smaller margins on
abstract, title case for title and so on). 
